...
const PromptModal = ({ setTagline, setPrompt, isVisible, setIsVisible, charLimit }) => {

    const charNum = charLimit ? charLimit : 50;
            ...
            <View style={styles.centeredView}>
                {selectedPrompt ? (
                    <View style={{ height: "70%", bottom: isKeyboardVisible ? "10%" : 0, ...styles.modalView }}>
                        ...
                        />
                        <Text style={{ color: "grey" }}>{charNum} character limit</Text>
