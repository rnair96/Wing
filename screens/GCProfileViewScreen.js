...
export const GCProfileViewScreen = () => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
            ...
            {/* <View> */}
            {(!loading && profile && profile?.prompts && profile.prompts.length > 0 && profile?.images && profile?.images.length > 2 && profile?.values && profile?.values.length > 2 && profile?.location && !(profile?.flagged_status && profile?.flagged_status==="unresolved")) ? (
                <View>
                    <FlatList
                        data={[profile]}
                    ...
                    <Text style = {{padding: 10, fontSize: 25, color:"white", fontWeight:"bold"}}>{card.item.rank}</Text>
                                ...
                                <View style={{ justifyContent: "center", alignItems: "center", padding: 2, paddingBottom: 70 }}>
                                    <TouchableOpacity style={{ padding: 30, marginBottom: 10, backgroundColor: "white", borderRadius: 10, borderWidth: 2, borderColor: "#00BFFF", width: "95%", alignItems: "center", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.5, shadowRadius: 2.41, elevation: 5 }} onPress={() => setIsMessageModalVisible(true)}>
                                        {/* <Ionicons name="arrow-down" size={30} color="#00BFFF" /> */}
                                        <Text style={{ color: "#00BFFF", fontWeight: "bold", fontSize: 17 }}>Message {card.item.displayName}</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={{ padding: 30, marginBottom: 10, backgroundColor: "white", borderRadius: 10, borderWidth: 2, borderColor: "#00BFFF", width: "95%", alignItems: "center", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.5, shadowRadius: 2.41, elevation: 5 }} onPress={() => setIsFlagModalVisible(true)}>
                                        {/* <Ionicons name="arrow-down" size={30} color="#00BFFF" /> */}
                                        <Text style={{ color: "#00BFFF", fontWeight: "bold", fontSize: 17 }}>Report {card.item.displayName}</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={{ padding: 30, marginBottom: 10, backgroundColor: "white", borderRadius: 10, borderWidth: 2, borderColor: "#00BFFF", width: "95%", alignItems: "center", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.5, shadowRadius: 2.41, elevation: 5 }} onPress={() => navigation.goBack()}>
                                        {/* <Ionicons name="arrow-down" size={30} color="#00BFFF" /> */}
                    ...
                    />
                    {/* <Foo ter/> */}
                    <FlagModal other_user={profile} isVisible={isFlagModalVisible} setIsVisible={setIsFlagModalVisible} type={"groupchat"} />
