  ...
  return (
    <ScrollView style={{ backgroundColor: "black" }}>
      <View style={{ flex: 1, padding: 10 }}>
        ...
        <Text style={{ padding: 10, color: "white" }}>1. Information We Collect
        ...
        <Text style={{ padding: 10, color: "white" }}>In addition, we may collect other information that you choose to provide us, such as a profile picture or a bio.
        ...
        <Text style={{ padding: 10, color: "white" }}>2. How We Use Your Information
        ...
        <Text style={{ padding: 10, color: "white" }}>3. Information We Share
        ...
        <Text style={{ padding: 10, color: "white" }}>4. Your Choices
        ...
        <Text style={{ padding: 10, color: "white" }}>5. Security
        ...
        <Text style={{ padding: 10, color: "white" }}>6. Children's Privacy
        ...
        <Text style={{ padding: 10, color: "white" }}>7. Changes to This Policy
        ...
        <Text style={{ padding: 10, color: "white" }}>8. Contact Us
