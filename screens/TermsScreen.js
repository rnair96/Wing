...
// import terms from '../legal/termsofservice.txt'
    ...
    return (
      <ScrollView style={{backgroundColor:"white"}}>
        <View style ={{flex:1, padding:10}}>
          <SafeAreaView>
          <Header style={{marginHorizontal:"17%"}} title = "Terms of Service"/>
          </SafeAreaView>
        <Text style={{padding:10}}>
          ...
          <Text style={{padding:10}}>1. Description of the Service
...
<Text style={{padding:10}}>2. Eligibility
...
<Text style={{padding:10}}>3. User Content
...
<Text style={{padding:10}}>4. Payment and Refunds
...
<Text style={{padding:10}}>5. Intellectual Property
...
<Text style={{padding:10}}>6. Disclaimers and Limitations of Liability
...
<Text style={{padding:10}}>7. Indemnification
...
<Text style={{padding:10}}>8. Changes to These Terms
...
<Text style={{padding:10}}>9. Termination
...
<Text style={{padding:10}}>10. Governing Law and Dispute Resolution
...
<Text style={{padding:10}}>11. Miscellaneous
...
<Text style={{padding:10}}>12. Contact Us
